...
userSchema.statics.googleAuth = async function (googleId, name, email, profilePicture) {
    try {
...
userSchema.statics.login = async function (email, password) {
    try {
        ...
        if (user.authProvider === "google" && !user.password) {
            throw new Error("This account is linked with Google. Please use Google Sign-in.");
        }
